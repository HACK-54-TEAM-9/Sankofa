...
export function VolunteerPage({ onNavigate }: VolunteerPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#10b981]/5 to-[#3b82f6]/5 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#10b981]/10 border border-[#10b981]/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm text-gray-700">Make a Difference</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl text-gray-900 mb-6">
              Volunteer with <span className="text-[#10b981]">Sankofa</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl text-gray-900 mb-2">15,000+</div>
                <div className="text-sm text-gray-600">Hours Contributed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl text-gray-900 mb-2">89</div>
                ...
                return (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="w-full bg-[#1a1a1a] hover:bg-[#2a2a2a] rounded-full"
                    >
                      Apply Now
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Card className="border-0 shadow-sm rounded-3xl p-6 md:p-8 bg-white">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="message">Why do you want to volunteer with Sankofa?</Label>
                  <Textarea
                    id="message"
