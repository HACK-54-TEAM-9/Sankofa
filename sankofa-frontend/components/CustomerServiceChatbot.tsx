...
const fallbackResponses: Record<string, string> = {
  'how does sankofa work': 'Sankofa transforms plastic pollution into healthcare access! Collectors bring plastic waste to collection hubs, get paid for their contributions, and help fund community health initiatives. Our AI analyzes the data to predict health risks in your area.',
  ...
  'default': 'Thank you for your question! Our team is here to help. For more information, please explore our website or contact us directly. Is there anything specific I can help you with about Sankofa?',
};
...
export function CustomerServiceChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'Hello! 👋 I\'m your Sankofa AI assistant. I can answer questions about our program, how to become a collector, plastic types we accept, and more. How can I help you today?',
      sender: 'bot',
      timestamp: new Date(),
    },
  ]);
