...
import { HubManagerApplicationForm } from './HubManagerApplicationForm';
...
export function HubManagerPage({ onNavigate }: HubManagerPageProps) {
  ...
  if (showApplicationForm) {
    return <HubManagerApplicationForm onBack={() => setShowApplicationForm(false)} />;
  }
    ...
    <div className="w-full">
      ...
      <section className="bg-[#08A26F] text-white py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 font-bold text-[32px] text-[24px]">
      ...
      {!isAuthenticated && (
        <section className="py-6 bg-stone-50 border-b border-stone-200">
          <div className="container mx-auto px-4">
            <Alert className="max-w-4xl mx-auto border-[#08A26F]/20 bg-[#08A26F]/5">
              <Info className="h-5 w-5 text-[#08A26F]" />
              <AlertDescription className="ml-2">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <Button
                    ...
                    className="bg-[#08A26F] hover:bg-[#059669] text-white rounded-xl gap-2 shrink-0"
                  >
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid gap-8 md:grid-cols-2 items-center max-w-6xl mx-auto">
            <div>
              <h2 className="mb-4 text-gray-900 font-bold text-[24px]">Who is a Hub Manager?</h2>
              <p className="text-lg text-gray-700 mb-6">
                Hub Managers are trusted community leaders like Elder Adjei who serve as the local face of Sankofa-Coin. They manage collection points, process transactions, and help Collectors succeed.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#08A26F]/10">
                    <CheckCircle2 className="h-5 w-5 text-[#08A26F]" />
                  </div>
                  <div>
                    <h4 className="text-gray-900 mb-1 font-bold">Community Leader</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-gray-900 mb-1 font-bold">Transaction Manager</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-gray-900 mb-1 font-bold">Health Advocate</h4>
            ...
            <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1751646312140-42e2dd2b2b23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzY2hvb2wlMjBjaGlsZHJlbiUyMGNvbGxlY3RpbmclMjBwbGFzdGljJTIwd2FzdGV8ZW58MXx8fHwxNzYxNTIzNjE5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                alt="School children collecting plastic waste"
      ...
      <section className="py-16 md:py-20 bg-stone-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 text-[24px] font-bold">
          ...
          <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto">
            <Card className="p-8 bg-white border-0 shadow-sm">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#08A26F] mb-6">
              ...
              <div className="text-sm text-stone-900 bg-stone-100 p-3 rounded-lg">
                Average earnings: GH₵800-1,500/month
              </div>
            </Card>

            <Card className="p-8 bg-white border-0 shadow-sm">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#FBBF24] mb-6">
            ...
            <Card className="p-8 bg-white border-0 shadow-sm">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-stone-600 mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="p-6 border-0 shadow-sm">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#08A26F]/10">
                    <Users className="h-6 w-6 text-[#08A26F]" />
                  </div>
                  <div>
                    <h3 className="mb-2 text-gray-900 font-bold">Community Standing</h3>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start gap-2">
                        <ArrowRight className="h-4 w-4 shrink-0 text-[#08A26F] mt-0.5" />
              ...
              <Card className="p-6 border-0 shadow-sm">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#08A26F]/10">
                    <Smartphone className="h-6 w-6 text-[#08A26F]" />
                  </div>
                  <div>
                    <h3 className="mb-2 text-gray-900 font-bold">Technical Requirements</h3>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start gap-2">
                        <ArrowRight className="h-4 w-4 shrink-0 text-[#08A26F] mt-0.5" />
              ...
              <Card className="p-6 border-0 shadow-sm">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#08A26F]/10">
                    <Award className="h-6 w-6 text-[#08A26F]" />
                  </div>
                  <div>
                    <h3 className="mb-2 text-gray-900 font-bold">Personal Qualities</h3>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start gap-2">
                        <ArrowRight className="h-4 w-4 shrink-0 text-[#08A26F] mt-0.5" />
              ...
              <Card className="p-6 border-0 shadow-sm">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#08A26F]/10">
                    <CheckCircle2 className="h-6 w-6 text-[#08A26F]" />
                  </div>
                  <div>
                    <h3 className="mb-2 text-gray-900 font-bold">Availability</h3>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start gap-2">
                        <ArrowRight className="h-4 w-4 shrink-0 text-[#08A26F] mt-0.5" />
      ...
      <section className="py-16 md:py-20 bg-stone-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 text-[24px] font-bold">Three simple steps to join our team</p>
          </div>

          <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto mb-12">
            <div className="text-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#08A26F] text-white mb-6 mx-auto">
                <span className="text-2xl">1</span>
              </div>
              <h3 className="mb-3 text-gray-900 font-bold">Review Criteria</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mb-3 text-gray-900 font-bold">Submit Application</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="mb-3 text-gray-900 font-bold">Complete Training</h3>
              <p className="text-gray-600">
          ...
          <div className="text-center">
            <Button
              ...
              className="bg-[#08A26F] hover:bg-[#059669] text-white rounded-xl gap-2"
            >
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 md:p-12 bg-[#08A26F]/10 border-0 shadow-sm">
              <div className="text-center mb-6">
                <div className="flex justify-center mb-4">
                  <div className="h-16 w-16 rounded-full bg-[#08A26F] flex items-center justify-center text-white text-2xl">
                    EA
                  </div>
                </div>
                <h3 className="text-gray-900 mb-2">Elder Adjei's Story</h3>
                <p className="text-sm text-[#08A26F]">Hub Manager, Accra Central</p>
              </div>
