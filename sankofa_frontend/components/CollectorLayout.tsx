  ...
  const quickActions = [
    {
      ...
      color: 'bg-[#08A26F] hover:bg-[#059669] text-white',
    },
    {
      id: 'ai-assistant',
      label: 'AI Assistant',
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-gray-200 p-6">
        ...
        <div className="flex items-center gap-3 p-3 bg-stone-50 rounded-xl border border-stone-200">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#08A26F] text-white">
            <User className="h-5 w-5" />
          </div>
          <div>
            <p className="text-sm text-gray-900">Collector</p>
            <p className="text-xs text-gray-600">Bronze Rank</p>
          </div>
        </div>
      </div>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition-colors ${
                  isActive
                    ? 'bg-[#08A26F]/10 text-[#08A26F] border border-[#08A26F]/20'
      ...
      <div className="border-t border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm text-gray-900 truncate">{user?.name || 'Collector'}</p>
    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
        <SheetContent side="left" className="w-72 p-0">
          <SheetTitle className="sr-only">Collector Navigation</SheetTitle>
          <SheetDescription className="sr-only">
            Navigate through your collector dashboard
          </SheetDescription>
          <SidebarContent />
        </SheetContent>
      </Sheet>
