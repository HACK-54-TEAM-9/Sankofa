    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1694286068362-5dcea7ed282a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibGFjayUyMHBlb3BsZSUyMG1ha2luZyUyMGRvbmF0aW9ucyUyMGFmcmljYXxlbnwxfHx8fDE3NjE1NDkyMTF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
            alt="People making donations"
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#FBBF24]/20 border border-[#FBBF24]/30 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm text-white">Support Our Mission</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="text-3xl text-white mb-2 font-bold">GH₵847K</div>
                <div className="text-sm text-white/80">Raised This Year</div>
              </div>
              <div className="text-center">
                <div className="text-3xl text-white mb-2 font-bold">12,400+</div>
                <div className="text-sm text-white/80">Lives Impacted</div>
              </div>
              <div className="text-center">
                <div className="text-3xl text-white mb-2 font-bold">98%</div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right">
                        <div className="text-3xl text-gray-900 font-bold">GH₵{tier.amount}</div>
                    ...
                    <Button
                      ...
                      className="w-full mt-6 bg-[#1a1a1a] hover:bg-[#2a2a2a] text-white hover:text-white rounded-full"
                    >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Card className="border-0 shadow-sm rounded-3xl p-6">
                ...
                <div className="text-xl text-gray-900 mb-2 font-bold">4,500 kg</div>
              ...
              <Card className="border-0 shadow-sm rounded-3xl p-6">
                ...
                <div className="text-xl text-gray-900 mb-2 font-bold">1,847 People</div>
                <p className="text-gray-600 mb-3">
              ...
              <Card className="border-0 shadow-sm rounded-3xl p-6">
                ...
                <div className="text-xl text-gray-900 mb-2 font-bold">23% Reduction</div>
                <p className="text-gray-600 mb-3">
