        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-[#08A26F]/10 border border-[#08A26F]/20 px-4 py-2 rounded-full mb-6">
                <Sparkles className="h-4 w-4 text-[#08A26F]" />
                <span className="text-sm text-[#08A26F]">AI-Powered Intelligence</span>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-3 mb-16">
              <div className="text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#08A26F] mb-6 mx-auto">
                  <Activity className="h-10 w-10 text-white" />
                </div>
                <div className="mb-4">
                  <span className="inline-block px-3 py-1 bg-stone-100 text-stone-600 rounded-full text-xs mb-3">
                    Step 1
                  </span>
                  <h3 className="text-gray-900 mb-3">Data Collection</h3>
                </div>
              ...
              <div className="text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#FBBF24] mb-6 mx-auto">
                ...
                <div className="mb-4">
                  ...
                  <h3 className="text-gray-900 mb-3">AI Analysis</h3>
                </div>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="text-center">
                ...
                <div className="mb-4">
                  ...
                  <h3 className="text-gray-900 mb-3">Actionable Insights</h3>
                </div>
                <p className="text-gray-600 leading-relaxed">
            ...
            {/* Privacy Notice */}
            <Card className="p-8 bg-stone-50 border-2 border-stone-200 rounded-2xl">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-[#FBBF24]/10 rounded-full flex items-center justify-center shrink-0">
                  <Info className="h-6 w-6 text-[#FBBF24]" />
                </div>
                <div className="flex-1">
                  <h4 className="text-gray-900 mb-3">Privacy & Data Protection</h4>
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    <button onClick={() => onNavigate('contact')} className="text-[#08A26F] hover:underline">
                      privacy policy
                    </button>.
                  </p>
                </div>
