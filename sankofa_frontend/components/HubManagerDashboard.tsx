            ...
            <Card className="bg-white border-0 shadow-sm">
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-[#08A26F]/10 rounded-xl border border-[#08A26F]/20">
                    <div>
                      <p className="text-sm text-stone-900 mb-1">
                        Avg. Collection
                      </p>
                  ...
                  <div className="flex items-center justify-between p-3 bg-[#FBBF24]/10 rounded-xl border border-[#FBBF24]/20">
                    <div>
                      <p className="text-sm text-stone-900 mb-1">
                        Processing Rate
                      </p>
              ...
              <div className="p-6 text-white">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    variant="secondary"
                    size="sm"
                    className="flex-1 rounded-xl bg-[rgb(255,255,255)]"
                  >
            ...
            <Card className="bg-white border-0 shadow-sm">
              <div className="p-6">
                ...
                <div className="space-y-3">
                  <Button
                    variant="outline"
                    className="w-full justify-start rounded-xl border-stone-200"
